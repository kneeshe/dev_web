...
<html> 
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="style.css"> <!-- instancia o arquivo css -->
    ...
    <body>
        ...
        <img id="gato" src="demo_gato.jpg" alt="gato do demo"> <!-- imagem do gatinho que aparece no site -->
